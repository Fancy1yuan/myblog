    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Required. 30 characters or fewer. Letters, digits and @/./+/-/_ only.', unique=True, max_length=30, verbose_name=b'\xe6\x98\xb5\xe7\xa7\xb0', validators=[django.core.validators.RegexValidator(b'^[\\w.@+-]+$', b'Enter a valid username.', b'invalid')])),
                ('first_name', models.CharField(max_length=30, verbose_name=b'\xe5\x90\x8d\xe5\xad\x97', blank=True)),
                ('last_name', models.CharField(max_length=30, verbose_name=b'\xe5\xa7\x93\xe6\xb0\x8f', blank=True)),
                ('email', models.EmailField(unique=True, max_length=75, verbose_name=b'\xe9\x82\xae\xe7\xae\xb1', blank=True)),
                ('phone_num', models.IntegerField(max_length=11, verbose_name=b'\xe6\x89\x8b\xe6\x9c\xba')),
                ('avatar', models.ImageField(default=b'uploads/avatar/default.jpg', height_field=90, width_field=90, upload_to=b'uploads/avatar/%Y/%m/', verbose_name=b'\xe7\x94\xa8\xe6\x88\xb7\xe5\xa4\xb4\xe5\x83\x8f')),
                ('description', models.CharField(max_length=100, verbose_name=b'\xe4\xb8\xaa\xe4\xba\xba\xe7\xae\x80\xe4\xbb\x8b')),
                ('is_staff', models.BooleanField(default=False, help_text='Designates whether the user can log into this admin site.', verbose_name='staff status')),
                ('is_active', models.BooleanField(default=True, help_text=b'Designates whether this user should be treated as active. Unselect this instead of deleting accounts.', verbose_name='active')),
